  ...
  return (
    <div className="wrapper">
      ...
      <section style={{ display: "grid", gap: "1.5rem", fontSize: "1.05rem", color: "var(--text-main)" }}>
        ...
        <div>
          <h2 style={{ fontSize: "1.25rem", marginTop: "1.5rem" }}>1. Data Collection</h2>
        ...
        <div>
          <h2 style={{ fontSize: "1.25rem", marginTop: "1.5rem" }}>2. Data Use and Sharing</h2>
          <p style={{ marginTop: "0.5rem" }}>
        ...
        <div>
          <h2 style={{ fontSize: "1.25rem", marginTop: "1.5rem" }}>3. Your Rights & Data Deletion</h2>
          <p style={{ marginTop: "0.5rem" }}>
        ...
        <div>
          <h2 style={{ fontSize: "1.25rem", marginTop: "1.5rem" }}>4. App-Specific Privacy</h2>
          <p style={{ marginTop: "0.5rem" }}>
            Specific details regarding the data storage and transmission of individual apps (like <em>Ta Psonia Mas</em> or <em>HonestCal</em>) will be detailed inside those respective applications or expanded on this page as they transition from development to public release.
          </p>
        </div>
